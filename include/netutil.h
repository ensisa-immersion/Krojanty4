/**
 * @file netutil.h
 * @brief Utilitaires réseau robustes pour communications TCP fiables
 * @author Équipe IMM2526-GR4
 * @date 17 septembre 2025
 * 
 * Ce fichier contient les utilitaires réseau fondamentaux pour assurer des
 ...
 * - Les fonctions inline optimisées pour les performances critiques
